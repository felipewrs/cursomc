package com.felipesilva.cursomc;
...
import com.felipesilva.cursomc.domain.ItemPedido;
...
import com.felipesilva.cursomc.domain.enums.EstadoPagamento;
import com.felipesilva.cursomc.domain.enums.Perfil;
import com.felipesilva.cursomc.domain.enums.TipoCliente;
import com.felipesilva.cursomc.repositories.CategoriaRepository;
import com.felipesilva.cursomc.repositories.CidadeRepository;
...
import com.felipesilva.cursomc.repositories.EstadoRepository;
import com.felipesilva.cursomc.repositories.ItemPedidoRepository;
import com.felipesilva.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli2 = new Cliente(null, "Ana Silva", "ana@gmail.com", "70935609113", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("1116363323", "84838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);

		Endereco e3 = new Endereco(null, "Rua Floriano", "300", "Apto 303", "Jardim", "38220834", cli2, c2);
