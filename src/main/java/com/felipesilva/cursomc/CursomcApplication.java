...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat2 = new Categoria(null, "Ecritório");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "70935609113", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("92225507", "98318733"));
